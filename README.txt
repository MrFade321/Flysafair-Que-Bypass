...
- [The Setup: Mapping the API](#the-setup-mapping-the-api)
- [The Queue: What Actually Happens](#the-queue-what-actually-happens)
- [The Sitemap Scan](#the-sitemap-scan)
- [The Client-Side Queue Check](#the-client-side-queue-check)
- [From Check-In to Everywhere](#from-check-in-to-everywhere)
